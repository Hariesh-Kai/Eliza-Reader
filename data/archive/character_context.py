...
# Words that strongly suggest the narration is
# describing someone's internal state.
...
def score_character_in_sentence(
    ...
    if lower_name not in lower_sentence:
        return 0, []
...
class ContextState:
    ...
    def update(
        ...
        # Do not switch POV based on a weak
        # single mention.
        if best["score"] >= 7:
        ...
        # Otherwise retain previous focus.
        return self.current_focus
